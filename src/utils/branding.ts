...
export const BRANDING_DOC_KEY = 'atomic-press-branding';
 ...
 *
 * Returns `null` when the doc has no `atomic-press-branding` key (no override).
...
export function prepareBrandingOverride(
	...
	for (const [k, v] of Object.entries(fm)) {
		// No recursion: ignore an `atomic-press-branding` key inside the branding file.
	...
	const headerComment =
		'# Auto-generated by atomic-press. Do not edit by hand.\n' +
