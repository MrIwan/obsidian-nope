...
title: Citation Test
author: Obsi Print
abstract: Tests Pandoc citeproc citations against `Obsi Test.bib`. Citations are formatted inline; the bibliography automatically appears at the document's end.
