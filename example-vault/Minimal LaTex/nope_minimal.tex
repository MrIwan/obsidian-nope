...
% "cancel" is NOT part of the base Docker image. Add "cancel" under Settings → LaTeX packages → Extra LaTeX packages and rebuild the image;
% the demobox in the example document then turns green and shows the package in action.
% Without it, a red box tells you the package is missing.
% (tcolorbox itself ships with the base image, so the box always renders.)
...
\IfFileExists{cancel.sty}{%
  ...
  \newenvironment{demobox}%
    {\begin{tcolorbox}[colback=red!5,colframe=red!60!black,title=cancel is NOT installed — add it under Settings \(\to\) LaTeX packages]}%
    {\end{tcolorbox}}%
}
% ------------------------------------------------------------------------------
